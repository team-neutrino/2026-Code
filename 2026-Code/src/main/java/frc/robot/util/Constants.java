...
public class Constants {
    ...
    public static class DriveToPointConstants {
        ...
        public static final Pose2d BLUE_PAST_BUMP_RIGHT = new Pose2d(5.742, 2.511, new Rotation2d(45));
        public static final Pose2d BLUE_PAST_BUMP_LEFT = new Pose2d(5.742, 5.558, new Rotation2d(45));
        public static final Pose2d RED_PAST_BUMP_LEFT = new Pose2d(10.799, 2.511, new Rotation2d(45));
        public static final Pose2d RED_PAST_BUMP_RIGHT = new Pose2d(10.799, 5.558, new Rotation2d(45));

        // Hub (4.626, 4.035)
        // Radius 3 meters
        public static final Pose2d BLUE_CENTER_SHOT = new Pose2d(1.626, 4.035, new Rotation2d(0));
        public static final Pose2d BLUE_RIGHT_SHOT = new Pose2d(2.505, 1.914, new Rotation2d(45));
