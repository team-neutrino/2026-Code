...
public class Constants {
    ...
    public static class DriveToPointConstants {
        ...
        public static final Pose2d BLUE_SHOOT_TOP = new Pose2d(2.28, 5.069326,
                new Rotation2d(Math.PI / 180 * Subsystems.swerve.calculateTargetAngle(2.28, 5.069326)));
        public static final Pose2d BLUE_SHOOT_MIDDLE = new Pose2d(3.35052752, 4.034663,
                new Rotation2d(Math.PI / 180 * Subsystems.swerve.calculateTargetAngle(3.35052752, 4.034663)));
        public static final Pose2d BLUE_SHOOT_BOTTOM = new Pose2d(2.28, 3,
                new Rotation2d(Math.PI / 180 * Subsystems.swerve.calculateTargetAngle(2.28, 3)));

        public static final Pose2d RED_SHOOT_TOP = new Pose2d(14.260988, 5.069326,
                new Rotation2d(Math.PI / 180 * Subsystems.swerve.calculateTargetAngle(14.260988, 5.069326)));
        public static final Pose2d RED_SHOOT_MIDDLE = new Pose2d(13.1904605, 4.034663,
                new Rotation2d(Math.PI / 180 * Subsystems.swerve.calculateTargetAngle(13.1904605, 4.034663)));
        public static final Pose2d RED_SHOOT_BOTTOM = new Pose2d(14.260988, 3,
                new Rotation2d(Math.PI / 180 * Subsystems.swerve.calculateTargetAngle(14.260988, 3)));
    ...
    public static class AutonConstants {
        public static final String CURRENT_AUTON = "Neutral Near L";
    }
}
