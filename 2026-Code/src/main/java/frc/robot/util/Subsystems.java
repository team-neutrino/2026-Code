...
public class Subsystems {
    public static final DriverDashboard hubState = new DriverDashboard();
    ...
    public static final ShootWhileMovingEstimatedPose swerve = new ShootWhileMovingEstimatedPose();
